namespace F89.Weapons
{
    ...
    {
        /// <summary>GAU-27A — crosshair moves freely inside a forward ogive envelope.</summary>
        OgiveDirect,

        /// <summary>GAU-27A (legacy) — crosshair slides along the nose, fires straight ahead only.</summary>
        ForwardOnly,
