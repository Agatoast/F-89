...
namespace F89.UI
{
    public static class RequestFuelConfirmDialog
    {
        public enum Result
        {
            None = 0,
        ...
        private static void EnsureStyles()
        {
            ...
            messageStyle = HudStyleFactory.CreateLabel(22, FontStyle.Bold, TextAnchor.MiddleCenter, Color.black, wordWrap: true);
        }
    }
}
