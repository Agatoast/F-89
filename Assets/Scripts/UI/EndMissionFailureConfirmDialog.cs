...
namespace F89.UI
{
    public static class EndMissionFailureConfirmDialog
    {
        public enum Result
        {
            None = 0,
        ...
        private const float DialogHeight = 240f;
        ...
        public static Result Draw(bool visible)
        {
            ...
            GUI.Label(
                ...
                "Ending the mission now will result in mission failure and a significant negative effect on your career.",
                messageStyle);
